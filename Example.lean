...
#eval qs hello (part := hoare.partition)
#eval qs hello (part := lomuto.partition)
...
#eval! qs #[9,  3,  1,  8,  6,  2,  5,  -0,  7,  4] (part := hoare.partition) (left := 1) (right := 1000) -- EXPECT ERROR: "index out of bounds" with partially sorted output
#eval! qs #[9,  3,  1,  8,  6,  2,  5,  -0,  7,  4] (part := lomuto.partition) (left := 1) (right := 1000) -- EXPECT ERROR: "index out of bounds" with partially sorted output
